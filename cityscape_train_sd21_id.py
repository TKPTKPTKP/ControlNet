...
# Configs
resume_path = './models/control_sd21_id_ini.ckpt'
batch_size = 2
logger_freq = 300
learning_rate = 1e-5
sd_locked = True
...
# Misc
dataset = Cityscape(use_id=True)
dataloader = DataLoader(dataset, num_workers=0, batch_size=batch_size, shuffle=True)
# logger = ImageLogger(batch_frequency=logger_freq)
trainer = pl.Trainer(gpus=1, precision=32, max_epochs=50, accumulate_grad_batches=2)
